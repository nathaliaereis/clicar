   ...
   <div id="box-tudo">
    	...
    	<div id="box-central">
        	<div id="box-conteudo2">
                  ...
                  <P>  Verifique se já temos uma resposta para você aqui em <a href="perguntasfrequentes.php">Dúvidas Freqüentes </a> </P>
                  <br />
                   <p> Sua opinião é fundamental para que o Clicar possa, cada vez mais, inovar e oferecer o melhor a você em produtos e serviços.</p> 
                   <P> Para informações, críticas ou elogios, envie um e-mail.
                    faleconosco@Clicar.com.br</P>
